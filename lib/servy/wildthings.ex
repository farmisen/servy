defmodule Servy.Wildthings do
  ...
  def get_bear(bear_id) when is_integer(bear_id) do
    list_bears() |> Enum.find(fn %{id: id} -> id == bear_id end)
  end

  def get_bear(bear_id) when is_binary(bear_id) do
    bear_id |> String.to_integer() |> get_bear()
  end
end
